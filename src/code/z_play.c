...
void Play_TakePictoPhoto(PreRender* prerender) {
    ...
    Play_ConvertRgba16ToIntensityImage(gHiBuffer.gPictoPhotoI8, prerender->fbufSave, SCREEN_WIDTH, PICTO_PHOTO_TOPLEFT_X,
...
void Play_Init(GameState* thisx) {
    ...
    this->pictoPhotoI8 = gHiBuffer.gPictoPhotoI8;
