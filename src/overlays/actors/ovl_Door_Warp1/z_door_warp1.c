...
void func_808BAE9C(DoorWarp1* this, PlayState* play) {
    ...
    gSPSegment(POLY_XLU_DISP++, 0x08,
               Gfx_TwoTexScroll(play->state.gfxCtx, G_TX_RENDERTILE, sp94 % 256U, -((s16)(2.0f * this->unk_1AC) % 512U),
                                256, 256, 1, sp94 % 256U, -((s16)(2.0f * this->unk_1AC) % 512U), 256, 256));
    ...
    if (this->unk_1B0 > 0.0f) {
        ...
        sp94 *= 2;
        gSPSegment(POLY_XLU_DISP++, 0x08,
                   Gfx_TwoTexScroll(play->state.gfxCtx, G_TX_RENDERTILE, sp94 % 256U, -((s16)this->unk_1AC % 512U), 256,
                                    256, 1, sp94 % 256U, -((s16)this->unk_1AC % 512U), 256, 256));
